...
namespace BookInventory.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(BookInventoryDbContext context)
        {
            _context = context;
        }
        ...
        {
            var bookInventoryDbContext = _context.Books.Include(b => b.MsGenre);
            return View(await bookInventoryDbContext.ToListAsync());
        }
